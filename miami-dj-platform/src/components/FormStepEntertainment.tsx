...
export const FormStepEntertainment: React.FC = () => {
  ...
  return (
    <div>
      <h2 className="text-xl font-bold mb-4 text-blue-700 drop-shadow animate-pulse dark:text-blue-200">
        Entertainment Selection
      </h2>
      <div className="mb-4">
        <label className="block mb-1 font-medium text-blue-700 dark:text-blue-200">
        ...
        <div className="grid grid-cols-1 gap-3">
          ...
          {mainOptions.map((opt) => {
            ...
            return (
              <label
                key={opt.value}
                className={`flex items-center gap-3 p-3 rounded border transition-colors duration-200 cursor-pointer ${
                  isSelected
                    ? "bg-blue-100 border-blue-200 shadow-lg"
                    : "bg-blue-50 dark:bg-black border-blue-100 dark:border-gray-900 opacity-40 grayscale"
                }`}
              >
                <input
                  type="checkbox"
                ...
                <span className="text-xs text-blue-400 dark:text-gray-300">
                  {opt.description}
                </span>
              </label>
            );
            ...
            return (
              <label
                ...
                className={`flex items-center gap-3 p-3 rounded border transition-colors duration-200 cursor-pointer ${
                  ...
                  disableAddons ? "opacity-50 grayscale cursor-not-allowed" : ""
                }`}
              >
                <input
                  type="checkbox"
        ...
        {errors.entertainmentType && (
          <span className="text-red-500 text-sm">
            Select at least one entertainment type.
          </span>
        )}
      </div>
    </div>
