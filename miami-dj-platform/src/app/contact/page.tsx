  ...
  return (
    <div className="min-h-screen py-6 px-2 sm:py-12 sm:px-4 bg-white dark:bg-black flex flex-col items-center">
      ...
      <div className="max-w-xl w-full bg-white dark:bg-gray-900 rounded-lg shadow p-4 sm:p-6 mb-8">
        ...
        <p className="mb-2">123 Ocean Drive, Miami, FL</p>
        <p className="mb-2">Phone: <a href="tel:+13055551234" className="text-coral">(305) 555-1234</a></p>
        <p className="mb-2">Email: <a href="mailto:info@miamidj.com" className="text-coral">info@miamidj.com</a></p>
        <p className="mb-2">Hours: Mon-Sat 9am-7pm</p>
        <div className="mt-4">
          <iframe
